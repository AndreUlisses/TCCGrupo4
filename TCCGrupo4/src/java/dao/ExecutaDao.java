...
public class ExecutaDao {
    ...
    public int salvar(Executa executa) {
        ...
        try {
            ...
            String QUERY_UPDATE = "update EXECUTA set idFuncionario = ?, idChamado = ? where idpessoa = ? ";
    ...
    public boolean excluir(Executa executa) {
        ...
        try {
            ...
            String QUERY_DELETE = "delete from EXECUTA where idusuario = ?";
    ...
    public Executa editar(int id) {
        ...
        try {
            ...
            String QUERY_DETALHE = "select * from EXECUTA where idpessoa = ?";
            PreparedStatement stmt = null;
            Connection conn = ConnectionManager.getConnection();
